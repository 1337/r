...
(function() {
  ...
  define(['jquery', 'underscore', 'marionette', 'Models', 'imagesloaded'], function($, _, Marionette, Models, imagesLoaded) {
    ...
    Views.CommentsView = (function(_super) {
      ...
      CommentsView.prototype.childView = (function(_super1) {
        ...
        _Class.prototype.onShow = function() {
          var filteredComments, firstChild, hasReplies, replies, repliesView, _ref, _ref1, _ref2, _ref3;
          ...
          hasReplies = (_ref = this.model.get('replies')) != null ? (_ref1 = _ref.data) != null ? (_ref2 = _ref1.children) != null ? _ref2.length : void 0 : void 0 : void 0;
          ...
          return (_ref3 = this.replies) != null ? _ref3.show(repliesView) : void 0;
        };
    ...
    Views.MenuView = (function(_super) {
    ...
    Views.PostView = (function(_super) {
      ...
      PostView.prototype.templateHelpers = {
        ...
        thumb: function() {
          ...
          url = (_ref = this.media) != null ? (_ref1 = _ref.oembed) != null ? _ref1.thumbnail_url : void 0 : void 0;
          if (url) {
    ...
    Views.ContentView = (function(_super) {
    ...
    Views.HistoryView = (function(_super) {
      ...
      HistoryView.prototype.childView = (function(_super1) {
        __extends(_Class, _super1);
    ...
    Views.SettingsView = (function(_super) {
